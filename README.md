...
These pins that has the same number (1a, 1b) or (2a, 2b) is always connect. But, these differences number (1 - 2) is not connect. They only connect when push the button.
